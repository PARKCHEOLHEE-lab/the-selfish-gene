...
class EnvironmentHelper:
    ...
    def _save_result_data(self, collections: dict):
        ...
        data_path = f"data/result-{formatted_date_time_for_filename}.json"
    ...
    def _save_visualized_result(self, data_path):
...
class Environment(EnvironmentHelper):
    ...
    def simulate(self) -> None:
        ...
        data_path = self._save_result_data(collections)
        self._save_visualized_result(data_path)
